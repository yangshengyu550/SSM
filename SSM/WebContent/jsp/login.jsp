...
.panel-login input[type="text"], .panel-login input[type="email"],
	.panel-login input[type="password"], .panel-login input[type="tel"] {
	height: 45px;
...
.bg {
	background:
		url('https://wallpapers.wallhaven.cc/wallpapers/full/wallhaven-714676.jpg');
	height: 850px;
	text-align: center;
	line-height: 750px;
	z-index: -2;
...
<script type="text/javascript">
	...
	if(msg!=""&&msg!='null'&&msg!=null&&msg!=''){
		alert(msg);
		window.location.href="http://localhost:8080/SSM/login";
	}
</script>
</head>
<body>
	<div class="container" style="postition:fixed;">
		<div class="row">
						...
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="./logincheck" method="post"
									...
									<div class="form-group">
										<label for="username1">用户名</label> <input type="text"
											name="role_name" id="username1" tabindex="1"
											class="form-control" placeholder="Username" value="">
									</div>
									<div class="form-group">
										<label for="password1">密码</label> <input type="password"
											name="role_pwd" id="password1" tabindex="2"
											class="form-control" placeholder="Password">
									</div>
									<div class="form-group text-center">
										<input type="checkbox" tabindex="3" class="" name="remember"
											id="remember"> <label for="remember">始终记住密码</label>
									</div>
									<div class="form-group">
										<div class="row">
								...
								<form id="register-form"
									...
									<div class="form-group">
										<label for="password2">确定密码</label> <input
										...
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit"
													...
													class="form-control btn btn-register" value="注册">
											</div>
										</div>
									</div>
								</form>
	...
	<script type="text/javascript" color="0,0,0" opacity='0.9' zIndex="-1" count="199" src="http://cdn.bootcss.com/canvas-nest.js/1.0.1/canvas-nest.min.js"></script>
</body>
</html>
